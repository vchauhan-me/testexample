...
gulp.task("Publish-Assemblies",
    function () {
        var root = "./src";
        var binFiles = root + "/**/code/**/bin/Sitecore.{Feature,Foundation,Senoko.Energy}.*.{dll,pdb}";
...
gulp.task("Auto-Publish-Assemblies",
    function () {
        ...
        var files = "/**/Sitecore.{Feature,Foundation,Senoko.Energy}.*.{dll,pdb}";;
        var destination = config.websiteRoot + "/bin/";
...
gulp.task("Package-Prepare-Package-Files",
    function (callback) {
        var excludeList = [
            ...
            "!" + config.websiteRoot + "\\bin\\Sitecore.{Feature,Foundation,Senoko.Energy,Demo,Common}*dll"
        ];
